...
Wall::Wall(WADTextureData& TextureData) : m_IsComposed(false), m_iOverLapSize(0), m_pOverLapColumnData(nullptr)
{
...
void Wall::Render(uint8_t* pScreenBuffer, int iBufferPitch, int iXScreenLocation, int iYScreenLocation)
{
...
void Wall::RenderColumn(uint8_t* pScreenBuffer, int iBufferPitch, int iXScreenLocation, int iYScreenLocation, int iCurrentColumnIndex)
{
    AssetsManager* pAssetsManager = AssetsManager::GetInstance();
